...
country_codes = {"Burkina Faso": "BF", "DR Congo": "CD", "Ethiopia": "ET", "Ghana": "GH", "Indonesia": "ID", "Kenya": "KE", "Niger": "NE", "Nigeria": "NG", "Uganda": "UG"}
questionnaire_codes = {"Household-Questionnaire": "HQ", "Female-Questionnaire": "FQ", "SDP-Questionnaire": "SQ", "Listing": "listing", "Selection": "sel", "Reinterview-Questionnaire": "RQ"}
xml_codes = {"HQ": "HHQ", "FQ": "FRS", "SQ": "SDP", "listing": "listing", "sel": "Selection", "RQ": "RQ"}
# Take xml_codes value and map to start and stop tags for location
location_brackets = {"HHQ": ("<manual_date/>", "<hh_duplicate_check/>"), 
